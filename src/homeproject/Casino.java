...
public class Casino {
    ...
    public static void croupier() {
        ...
        do {
            clear();
            System.out.println("\n" + Table.ANSI_BLUE + inGamePlayers.get(playerIndex).getName() + Table.ANSI_RESET + ". Please enter how much money would you like to bet.");
            ...
            do {
                try {
                    ...
                    System.out.println(inGamePlayers.get(playerIndex).getName() + Table.ANSI_RED + " Your input is not a number. Please enter only number values..." + Table.ANSI_RESET);
                    correct = false;
                }
            } while (!correct);
            ...
            String[] liveMain = {"Number", "Vertical pair", "Horizontal pair",
                    ...
                    "Even-Odd", "Colour"}; //11
            int path = Game.choosePath(liveMain, "from the bets menu", Table.ANSI_BLUE + inGamePlayers.get(playerIndex).getName() + Table.ANSI_RESET + ". Please enter the number where you want to place your bet.");
